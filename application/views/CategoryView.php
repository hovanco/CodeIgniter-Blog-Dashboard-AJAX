...
<body>
  ...
  $(document).on("click", "#add", function(e) {
    ...
    if (name == "") {
      ...
      $.ajax({
        url: "<?php echo base_url(); ?>index.php/category_controller/insert",
        type: "post",
        dataType: "json",
        data: {
          name: name
  ...
  function fetch() {
    $.ajax({
      url: "<?php echo base_url(); ?>index.php/category_controller/fetch",
      type: "post",
      dataType: "json",
      success: function(data) {
        if (data.responce == "success") {
  ...
  $(document).on("click", "#delete", function(e) {
    ...
    swalWithBootstrapButtons.fire({
      ...
      if (result.value) {
        ...
        $.ajax({
          url: "<?php echo base_url(); ?>index.php/category_controller/delete",
          type: "post",
          dataType: "json",
          data: {
            delete_id: delete_id
  ...
  $(document).on("click", "#edit", function(e) {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>index.php/category_controller/edit",
      type: "post",
      dataType: "json",
      data: {
        edit_id: edit_id,
      ...
      success: function(data) {
        ...
        $('#edit_record_id').val(data.category.id);
  ...
  $(document).on("click", "#update", function(e) {
    ...
    if (edit_record_id == "" || edit_name == "") {
      ...
      $.ajax({
        url: "<?php echo base_url(); ?>index.php/category_controller/update",
        type: "post",
        dataType: "json",
        data: {
