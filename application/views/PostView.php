...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>vendor/dashboard/datatables.net-bs4/css/dataTables.bootstrap4.min.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>vendor/dashboard/datatables.net-buttons-bs4/css/buttons.bootstrap4.min.css">
...
<body>
	<aside id="left-panel" class="left-panel"><!-- Left Panel -->
			...
			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="menu-item-has-children dropdown">
						...
						<i class="menu-icon fa fa-laptop">
	...
	<div id="right-panel" class="right-panel"><!-- Right Panel -->
			...
			<div class="header-menu">
				<div class="col-sm-7">
					...
					<div class="header-left">
						...
						<a href="<?= base_url() ?>index.php/user_controller">User</a>
				...
				<div class="col-sm-5">
					<div class="user-area dropdown float-right">
						...
						<div class="user-menu dropdown-menu">
							...
							<a class="nav-link" href="<?= base_url() ?>index.php/login_form_controller/getLogout"><i class="fa fa-power-off"></i> Logout</a>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-body">
								<div class="btn-add">
									<small style="margin-bottom: 10px;"><a href="<?= base_url() ?>index.php/post_controller/add_post_form" 
									class="btn btn-success btn-xs" style="border-radius:5px; color: #fff; border-color: #007bff; background-color: #007bff;  " >Add Post <i class="fa fa-plus"></i></a>
									</small>
								</div>
								<br/>
								<table id="bootstrap-data-table-export" class="table table-striped table-bordered">
									...
									<tbody>
										...
										<?php foreach ($posts as $key => $post) : ?>
											<tr>
												<td class="td-image">
												 <img style="max-width: 100px;" src="<?= $post['image'] ?>">
												</td>
												<td class="td-style"><?= $post['created_at'] ?></td>
												<td class="td-style"><?= $post['title'] ?></td>
												<td class="td-content-style"><?= $post['content'] ?></td>
												<td class="td-action">
													<small><a href="<?= base_url() ?>./index.php/post_controller/update_post/<?= $post['id'] ?>" 
													class="btn btn-warning btn-xs" style="border-radius: 5px; color:#fff;">Update <i class="fa fa-pencil"></i></a>
													</small>
													<small><a href="<?= base_url() ?>./index.php/post_controller/delete_post/<?= $post['id'] ?>" 
													class="btn btn-danger btn-xs" style="border-radius: 5px;">Delete <i class="fa fa-remove"></i></a>
													</small>
													<small><a href="<?= base_url() ?>./index.php/post_controller/detail_post/<?= $post['id'] ?>" 
													class="btn btn-outline-success btn-xs"style="border-radius: 5px; color:#fff; background-color:green; width:100px">Details </a>
							          	</small>
												</td>
											</tr>
										<?php endforeach ?>
	...
	<script src="<?php echo base_url(); ?>vendor/dashboard/datatables.net-buttons-bs4/js/buttons.bootstrap4.min.js"></script>
