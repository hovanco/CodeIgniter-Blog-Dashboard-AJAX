				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-body">
								<div class="btn-add">
									<small style="margin-bottom: 10px;"><a href="<?= base_url() ?>index.php/user_controller/add_user_form" 
									class="btn btn-success btn-xs" style="border-radius:5px; color: #fff; border-color: #007bff; background-color: #007bff;  " >Add User <i class="fa fa-plus"></i></a>
									</small>
								</div>
								<br/>
								<table id="bootstrap-data-table-export" class="table table-striped table-bordered">
									...
									<tbody>
										...
										<?php foreach ($arr_result as $key => $value) : ?>
											<tr>
											  <td>
													<img class="user-vatar" src="<?= $value['avatar'] ?>">
												</td>
