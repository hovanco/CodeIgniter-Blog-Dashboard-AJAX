			...
			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="menu-item-has-children dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop">
														...
														<div class="modal-body">
															...
															<form id="addRecordForm">
																...
																<div class="input-group mb-3">
																	...
																	<input type="text" class="form-control" id="first_name" placeholder="first_name" aria-label="first_name" aria-describedby="basic-addon1">
																</div>
																...
																<div class="input-group mb-3">
																	...
																	<input type="text" class="form-control" id="last_name" placeholder="last_name" aria-label="last_name" aria-describedby="basic-addon1">
																</div>
																	...
																	<div class="col-md-12">
																		...
																		<form id="editForm">
																			...
																			<div class="input-group mb-3">
																				...
																				<input type="text" class="form-control" id="edit_first_name" placeholder="edit_first_name" aria-label="edit_first_name" aria-describedby="basic-addon1">
																			</div>
																			...
																			<div class="input-group mb-3">
																				...
																				<input type="text" class="form-control" id="edit_last_name" placeholder="edit_last_name" aria-label="edit_last_name" aria-describedby="basic-addon1">
																			</div>
																			...
																			<div class="input-group mb-3">
																				...
																				<input type="number" class="form-control" id="edit_phone_number" placeholder="edit_phone_number" aria-label="edit_phone_number" aria-describedby="basic-addon1">
																			</div>
																			...
																			<div class="input-group mb-3">
																				...
																				<input type="text" class="form-control" id="edit_user_name" placeholder="edit_user_name">
																			</div>
  ...
  <script src="https://cdn.jsdelivr.net/npm/sweetalert2@9"></script>
	...
	<script>
		...
		$(document).on("click", "#add", function(e) {
			...
			if (first_name == "" || last_name == "" || phone_number == "" || email == "" || user_name == "" || avatar.name == "") {
